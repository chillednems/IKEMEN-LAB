...
/** Maps one private working library to its optional source-folder capability. */
public final class LibraryBinding {
    ...
    /** Call only after the import's private staging and scan have succeeded. */
    ...
    private static String key(File root) throws IOException {
        // Import roots are app-private UUID directories. The full canonical path prevents cross-library reuse.
